...
const HomePageFrameLeftComponent = ({ data, className = "", maxWords = 40, isExpanded, onExpand }) => {
  ...
  return (
    <div className={`self-stretch flex flex-row items-start justify-start gap-[42px] max-w-full text-left text-5xl text-primary-colour font-inter mq750:gap-[21px] mq1275:flex-wrap`}>
