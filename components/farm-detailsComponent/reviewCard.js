...
const ReviewCard = ({ image, name, description, ratings, phoneNumber, email, phoneImage }) => {
  return (
    <div className="bg-white lg:w-[1500px] w-screen mx-auto text-black rounded-xl shadow-md overflow-hidden flex flex-col justify-center items-center lg:flex-row lg:justify-start lg:items-start font-inter mt-10 pb-4 gap-x-20">
      ...
      <div className="items-center justify-center  sm:max-w-sm w-[300px] md:h-[200px] bg-white lg:ml-16 rounded-lg shadow-md p-6 border border-primary-colour flex flex-col gap-2 text-justify sm:w-auto"
           style={{ border: '1px solid #378805' }}>
        <div className="">
