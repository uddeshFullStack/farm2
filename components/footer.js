  ...
  return (
    ...
    >
      ...
      <div className="md:mx-8 self-stretch flex flex-row items-start justify-end py-0  box-border max-w-full mq750:pl-2 mq750:pr-[3px] mq750:box-border">
        <div className="flex flex-row items-start justify-between max-w-full gap-[3px] lg:gap-[300px] mq1275:flex-wrap">
          <div className=" flex flex-col items-start justify-start gap-y-5">
            <div className="">
              ...
              <blockquote className="m-0 self-stretch h-24 relative text-base inline-block shrink-0 text-white">
                ...
                <p className="m-0 text-justify" style={{ textAlign: "justify" }}>
