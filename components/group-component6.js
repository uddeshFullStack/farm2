...
const GroupComponent6 = ({ className = "" }) => {
  return (
    <div
      className={`w-[403px] shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] rounded-md bg-white flex flex-col items-start justify-start p-[19px] box-border gap-[15px] min-w-[383px] max-w-full z-[2] text-left text-base text-lite font-inter mq450:min-w-full ${className}`}
    >
      <div className="w-[403px] h-[485px] relative hidden max-w-full">
        ...
        <div className="absolute top-[268px] left-[110px] text-2xs font-medium text-star-listed-lite-color text-center inline-block min-w-[45px]">
          (12,365)
        </div>
        <img
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[23px] max-w-full text-lg text-primary-colour">
        <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
          ...
          <div className="self-stretch flex flex-row items-end justify-between gap-[20px] text-center text-base text-lite mq450:flex-wrap">
            <div className="w-[136px] flex flex-col items-start justify-start gap-[11.3px]">
              <div className="self-stretch flex flex-row items-start justify-start gap-[7.2px] text-2xs text-star-listed-lite-color">
              ...
              <div className="w-[102px] relative font-medium inline-block min-w-[102px] z-[3]">
                Nearest City
              </div>
              <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0.5 pl-px text-left">
            ...
            <div className="w-28 flex flex-col items-end justify-start gap-[13.7px] text-right text-taxt-colour">
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 pr-1.5 pl-1 box-border max-w-full">
          <button className="cursor-pointer [border:none] py-[7px] px-5 bg-secondary-colour flex-1 rounded-8xs overflow-hidden flex flex-row items-start justify-center box-border whitespace-nowrap max-w-full z-[3] hover:bg-goldenrod">
