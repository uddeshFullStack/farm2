export const  cardsData = [
    {
      ...
      description:
        'We are committed to promoting sustai-nable farming practices that protect the environment, conserve natural resources, and ensure the long-term viability of agriculture.',
    },
    {
      image: require(`../public/aboutUs/Instagram Verification Badge.jpg`).default,
      heading: 'Community',
      description:
        'We believe in the strength of commu-nity and actively engage with local farmers, artisans, and villagers to foster meaningful connections and support local economies',
    },
    {
  ...
  export const  profileCards = [
    {
      ...
      name: 'Courtney Henry',
      description:
        'Co-Founder and Creative Director with 3 year experience in the industry. Inspired and motivated on a daily basis to help brands grow.',
    },
    {
